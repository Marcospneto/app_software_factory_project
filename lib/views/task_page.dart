    ...
    try {
      if (_formKey.currentState?.saveAndValidate() ?? false) {
        ...
        var task = Task(
          ...
          priority: TaskPriority.fromString(_priorityController.text) ?? TaskPriority.SIMPLE,
          repeatFrequency: RepeatFrequency.fromString(_recurrenceController.text),
          notification: NotificationEnum.fromString(_notificationController.text) ?? NotificationEnum.NO_NOTIFICATION,
          shieldedTask: _isSelected,
          observation: _observationController.text,
          userId: _currentUser!.id!,
        );

        final isShieldedTask = await taskRepository.hasShieldTaskAtDateTime(
          userId: _currentUser!.id!,
          date: _dataController.text,
          startTime: _startTimeController.text,
          endTime: _endTimeController.text,
