...
class _AnalyticalReportPageState extends State<AnalyticalReportPage> {
            ...
            isLoading  
              ...
              : taskRealizadaBarChart(barChartData)
                  ...
                  : Padding(
                      ...
                      child: Text(
                        'Nenhuma tarefa concluída ${getPeriodLabel(selectedPeriod)} para exibição do gráfico de barras.',
                        style: TextStyle(
                          fontSize: 14,
                ...
                : SizedBox(
                    ...
                    child: Center(
                      child: Padding(
                        ...
                        child: Text(
                          'Nenhuma tarefa concluída ${getPeriodLabel(selectedPeriod)} para exibição do gráfico de pizza.',
                          style: TextStyle(
                            fontSize: 14,
                            fontWeight: FontWeight.bold,
                            color: Colors.grey[600],
  ...
  String getPeriodLabel(PeriodType periodType) {
    switch (periodType) {
      case PeriodType.dia:
        return 'neste dia';
